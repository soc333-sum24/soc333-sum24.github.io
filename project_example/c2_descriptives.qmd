...
-   Will you analyze all the observations in your data set? Explain why or why not.
    If not, which will you include and which will you exclude?

    I will not analyze all of the observations in my data set because analyzing all of them would make for an unfair comparison. There is a different set of sports available for men than for women. 
