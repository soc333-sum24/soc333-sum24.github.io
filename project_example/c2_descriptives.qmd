...
There are no missing values.
I am surprised that there are so many more women's teams than men's teams. I would have expected the numbers to be about the same.
...
There are no missing values.
Most sports have either 76 or 38 distinct teams in my data. It is possible that the sports with 38 teams are those that are available only to one gender, and the ones with 76 (38x2) teams have both men's and women's versions. 
