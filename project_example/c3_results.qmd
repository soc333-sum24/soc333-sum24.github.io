...
-   Hypotheses:
    ...
    -   State your null hypothesis.
        ...
        Men's and women's teams will be assigned the same number of coaches, on average.
...
-   What statistical test will you use? Explain why this test is the right choice. (~1-3 sentences)
    ...
    I will use a T test. This is the right choice because T tests are appropriate for comparing means between two groups. My explanatory variable, team gender, is a categorical variable with two levels, and my response variable, number of coaches, is a numeric variable. I am comparing the mean of the number of coaches between the two represented team genders.
