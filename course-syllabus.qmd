...
We will generally meet from 11:15-12:30 Monday through Thursday (except Memorial Day and Juneteenth) in 329 Reuben-Cooke. See the [schedule](index.html) for more information.
...
We will spend a significant portion of our class time learning to apply concepts from lectures by doing in-class exercises. You will be expected to turn in the exercises from lecture before the next class period. For example, you will be expected to submit the Tuesday in-class exercises before class starts on Wednesday. These will be graded for completion--i.e., you will get full points if you show that you made a good-faith attempt to answer all parts.
