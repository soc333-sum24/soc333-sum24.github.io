...
```{r}
pnorm(q = 1) # q is the Z score (yes, it's confusing). Nel's Z score is 1 because their score is 1 standard deviation above the mean.
```
...
-   There's a relationship between number of standard deviations away from the mean (Z score) and percentile
