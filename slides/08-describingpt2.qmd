...
-   Project descriptive statistics
    ...
    -   Due Monday June 5. Instructions and example are posted on the website.
...
-   `filter(acs12, employment == "employed")` ::: incremental

-   condition: `employment == "employed"`

-   general structure: `variable` `comparison` `value`
