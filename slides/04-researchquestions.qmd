...
-   Instructions: [under "Project" on the course website](https://soc333-sum23.github.io/project-description.html)
...
-   5 components; \~1/week:
    ...
    2.  Descriptive statistics (June 1; June 5)
...
-   Instructions: [course website -\> Project -\> Component 1: Proposal](https://soc333-sum23.github.io/project-proposal.html)
...
What are the problems with these research questions?
Revise them to improve them.
...
-   Installation instructions on course webpage at [Computing -> Setup](https://soc333-sum23.github.io/computing-setup.html)
-   For step 8 (testing it out): instructions for cloning a repo at [Computing -> Cloning and committing](https://soc333-sum23.github.io/computing-clonerepo.html)

## Next time
-   Next lecture: Studies and sampling (the rest of what you need to know for the proposal)
-   Read IMS chapter 2
-   Look over instructions for the proposal ([Project -> Component 1: Proposal](https://soc333-sum23.github.io/project-proposal.html)); start thinking about data sets and questions (bring drafts for peer review Thursday)
