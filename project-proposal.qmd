...
-   Clearly state the specific research question. Make sure it fulfills the following requirements ([see slides](https://soc333-sum23.github.io/slides/03-computing.html#/title-slide) for more detail):
