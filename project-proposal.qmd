...
First, you need to locate and clone the repository ([instructions](https://soc333-sum23.github.io/computing-clonerepo.html)). Go to our [course github organization](https://github.com/soc333-sum23/soc333-sum23.github.io) and find the repository called **c1_proposal_yourusername**. Clone that repository. Open the document called *c1_proposal.qmd*. This is a template document where you will put your work. 
...
-   [`dds.discr`](https://www.openintro.org/data/index.php?data=dds.discr)
-   [`evals`](https://www.openintro.org/data/index.php?data=evals)
-   [`fatal_police_shootings`](https://www.openintro.org/data/index.php?data=fatal_police_shootings)
