---
title: "Component 1: Project proposal"
callout-icon: false
---
...
First, you need to locate and clone the repository ([instructions](https://soc333-sum23.github.io/computing-clonerepo.html)).
Go to our [course github organization](https://github.com/orgs/soc333-sum23/repositories) and find the repository called **c1_proposal_yourusername**.
Clone that repository.
Open the document called *c1_proposal.qmd*.
This is a template document where you will put your work.

Commit your changes regularly.
When you are done, render the document and push your work to github ([instructions](https://soc333-sum23.github.io/computing-clonerepo.html#how-to-commit-and-push-changes))

# Workshop questions

Read your group members' proposed research questions.
Then create a new GitHub issue on each of their repositories, copy and paste in these questions, and answer them.
...
If you really want to use a data set from elsewhere instead, talk to me.

Not all openintro data sets will work for this course because not all of them lend themselves to sociological questions (see below for research question requirements).
Choose data sets that have something to do with people, that contain real (not simulated, not demo) data, and that contain a bare minimum of 50 observations and two interesting variables.
...
I recommend the below data sets, all of which are included in openintro.
Click on the links to see some basic information about them.
To access any of them in R, just load the openintro package, then use their names.
...
-   Clearly state the specific research question.
    Make sure it fulfills the following requirements ([see slides](https://soc333-sum23.github.io/slides/03-computing.html#/title-slide) for more detail):
...
You should revise your questions if they need it.
...
-   **Meets expectations**: All required elements are completed and are accurate.
...
-   **Close to expectations**: There are some elements missing and/or inaccurate.
    There are some issues with formatting.

-   **Partial credit:** Major elements missing.
