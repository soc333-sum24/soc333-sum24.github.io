...
First, locate and clone the component 2 repository ([instructions](https://soc333-sum23.github.io/computing-clonerepo.html)). Go to our [course github organization](https://github.com/orgs/soc333-sum23/repositories) and find the repository called **c2_descriptives_yourusername**. Clone that repository. Open the document called *c2_descriptives.qmd*. This is a template document where you will put your work.

Commit your changes regularly. When you are done, render the document and submit by pushing your work to github ([instructions](https://soc333-sum23.github.io/computing-clonerepo.html#how-to-commit-and-push-changes)).
