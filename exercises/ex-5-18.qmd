...
We will be following the instructions in the [How to Set up Git]{.underline} section [of this webpage](https://rfortherestofus.com/2021/02/how-to-use-git-github-with-r/).

You can **skip** the subsections [Initialize a Git Repository]{.underline}, [View Commit History]{.underline}, and [Make a Commit and View More History]{.underline}
...
-   Go to the course organization at [https://github.com/soc333-sum23](#0){.uri} organization on GitHub.
    Click on the repo with the prefix **ex-5-18**.
...
-   Click *ex-5-18-test.qmd* to open the template Quarto file.
